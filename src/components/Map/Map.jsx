...
function Map({coordinates, setCoordinates, setBounds, places, setChildClicked, weatherData}) {
        ...
        <div className={classes.mapContainer}>
            ...
            >
                ...
                {weatherData?.list?.map((data, i) => (
                    ...
                    lat={data.coord.lat} 
                    lng={data.coord.lon} >
                        <img height= {100} src={`https://openweathermap.org/img/w/${data.weather[0].png}`} />
                    </div>
                ))}
            </GoogleMapReact>
